(function (vue, google, $) {
    Vue.component('vue-component-gmaps', {
        ...
        methods: {
             ...
             */
            initMap: function () {
                console.log("Initilizing map on", this.selector);
                console.log(settings.vue.gmaps.themes.getOptions(this.theme));
                this._gmap = new google.maps.Map($(this.selector)[0], settings.vue.gmaps.themes.getOptions(this.theme));
            ...
            fitForOneMarker: function () {
                console.log("fitting for one marker");
